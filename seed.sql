...
VALUES ('Frank Silverio', 'cliente cadastrado', 'frank@uol.com', '$2a$10$tHuWTwPhVyvYEshMAlxgdeO.hv1efK1sHpDfb9fx55jeTz8N4RnIe'), --senha = senha
       ...
       ('Aarão Antonio de Almeida', 'cliente cadastrado', 'aaa@aaa.aa', '$2a$10$PxwwCwWjr.eSvdibCVGFPuYXLLXUBMXUjwJ8kPj3wNV651RT/PgNq') --senha = aa
...
VALUES ('Fanfa Bar & Snacks', 'empresa', 'fanfa@fanfa.com', '$2a$10$xqsyrJdzGegqOlHewjtxwOrTuzARSY/g5N6xg0aT3zVrysPkI.3KG'), --senha = senha
       ...
       ('Immundos Sujinhos Vila Carrão', 'im@suj.com', '$2a$10$PxwwCwWjr.eSvdibCVGFPuYXLLXUBMXUjwJ8kPj3wNV651RT/PgNq'), --senha = aa
       ('Abjetos Sujinhos Higienópolis', 'ab@suj.com', '$2a$10$PxwwCwWjr.eSvdibCVGFPuYXLLXUBMXUjwJ8kPj3wNV651RT/PgNq'); --senha = aa
...
VALUES ('fanfafa@fanfa.com', 'seg', '16:00:00', '20:00:00'),
       ...
       ('suj@suj.com',       'qui', '16:00:00', '20:00:00'),
       ('ab@fanfa.com',      'sex', '16:00:00', '20:00:00');

INSERT INTO inline.empresa
VALUES ('fanfa@fanfa.com', '234152251', 1),
       ('suj@suj.com',     '213423455', 1);
...
VALUES ('fanfafa@fanfa.com', 'fanfa@fanfa.com', 2, '0S0E'),
       ...
       ('im@suj.com', 'suj@suj.com', 2, '3N4E'),
       ('ab@suj.com', 'suj@suj.com', 2, '7N7W');
...
VALUES (4, 'Muito bom, mas pode ser melhor', 'fanfafa@fanfa.com', 'emerson@elp.com'),
       ...
       (3, 'Regular', 'sprife@sprife.com', 'eloy@eloy.com'),
